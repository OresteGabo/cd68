...
@section('main-content')
    <div class="main-content">
                    ...
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
                                <h2 class="ml-lg-2">Gestion des Des enfants</h2>
                            </div>
        ...
        <div class="row mb-4 mt-5">
            <div class="col">
                <h2>Ajouter un enfant à un Atelier</h2>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="entertainment_id" id="entertainment_id" required>
                            @foreach ($entertainments as $entertainment)
                                <option value="{{ $entertainment->id }}">{{ $entertainment->label }}</option>
                            @endforeach
                        </select>
                        <label for="entertainment_id" class="form-label">Choisir un enfant:</label>
                        <select class="form-select" name="kid_id" id="entertainment_id" required>
                            @foreach ($kids as $kid)
                                <option value="{{ $kid->id }}">{{ $kid->family_name}} {{ $kid->first_name}}</option>
                            @endforeach
                        </select>
                    </div>
