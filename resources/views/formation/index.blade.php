...
<section id="contact">
    <div class="container-lg">
        ...
        <div class="text-center">
            <h2>Faire une demande ou poser une question</h2>
        </div>
            ...
            <div class="col-lg-6">
                <form method="POST" action="{{ route('prompt.store') }}">
                    ...
                    <div class="input-group mb-4">
                        ...
                        <input type="text" id="email" class="form-control" placeholder="e.g. mario@example.com" name="email"/>
                        <!-- tooltip -->
                        <span class="input-group-text">
                    ...
                    <div class="mb-4 mt-5 form-floating">
                        <textarea class="form-control" id="query" style="height: 140px" placeholder="query" name="description"></textarea>
